...
@pytest.mark.parametrize(
    ...
    (
        (
            lambda: DynamicCircuit(2).conditional("x", 1, classical_bit=0),
...
def test_braket_iqm_rejects_mid_circuit_measurement_without_feed_forward() -> None:
    circuit = DynamicCircuit(1).measure(0, classical_bit=0)
