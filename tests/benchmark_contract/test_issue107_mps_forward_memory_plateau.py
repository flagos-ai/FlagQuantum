...
def test_issue107_benchmark_entrypoint_resolves_repository_imports() -> None:
...
def test_issue107_plateau_audit_passes_bounded_rank_records() -> None:
    ranks = [
        {
            "rank": rank,
            "runs": [
...
def test_issue107_plateau_audit_rejects_leak_peak_and_missing_target() -> None:
    ranks = [
        {
            "rank": 0,
            "runs": [
