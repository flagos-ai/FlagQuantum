...
def test_mps_workspace_audit_accepts_bounded_eight_rank_evidence() -> None:
    audit = audit_factorization_workspace(_payload())
    assert audit["passed"] is True
    assert audit["blockers"] == ()


def test_mps_workspace_audit_rejects_budget_retry_and_missing_rank() -> None:
...
def test_mps_workspace_audit_rejects_before_bond_saturation_depth() -> None:
    payload = _payload()
