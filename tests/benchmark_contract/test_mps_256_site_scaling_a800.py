...
NAME = "mps_training_256q_l3_b64_adam_{world_size}gpu_exact_prefetch_probe_20260805.json"
...
def test_256_site_exact_matrix_crosses_the_sixteen_gpu_threshold():
    ...
    assert artifacts[8]["mean_seconds"] / artifacts[16]["mean_seconds"] >= 1.05
    assert artifacts[8]["p50_seconds"] / artifacts[16]["p50_seconds"] >= 1.05
