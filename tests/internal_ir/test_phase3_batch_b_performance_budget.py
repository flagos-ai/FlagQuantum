...
from benchmarks.internal import ir_phase3_batch_b_gate as gate
...
def test_batch_b_machine_gate_accepts_boundary_and_rejects_regression(
    ...
    def observation(
        ...
        latency = budget["legalization_p95_ms_max"]
        if regression["enabled"] and operation_count == 1000:
            latency += 0.001
        return {
            "operation_count": operation_count,
            "legalization_p95_ms": latency,
            "legalization_peak_host_memory_bytes": budget[
                "legalization_peak_host_memory_bytes_max"
            ],
