...
AUTHORIZATION = ROOT / "contracts/ir-phase2-batch-c-exit-batch-d-authorization.json"
...
def test_batch_d_authorization_binds_exit_candidate() -> None:
...
def test_batch_d_authorization_keeps_later_gates_closed() -> None:
    ...
    assert decisions["batch_d_performance_baseline_authorized"] is True
