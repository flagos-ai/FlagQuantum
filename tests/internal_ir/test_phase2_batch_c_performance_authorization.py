...
AUTHORIZATION = (
    ROOT / "contracts/ir-phase2-batch-c-performance-budget-authorization.json"
)
VALIDATION = ROOT / "contracts/ir-phase2-batch-c-performance-budget-validation.json"
...
def test_batch_c_performance_authorization_keeps_later_gates_closed() -> None:
    ...
    assert decisions["batch_d_emitter_authorized"] is False
...
def test_batch_c_budget_validation_is_bound_and_fail_closed() -> None:
    ...
    assert validation["decisions"]["batch_d_emitter_authorized"] is False
