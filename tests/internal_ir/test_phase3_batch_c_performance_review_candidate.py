...
CANDIDATE = (
    ROOT / "contracts/ir-phase3-batch-c-performance-budget-review-candidate.json"
)
...
def test_batch_c_performance_candidate_binds_reviewed_evidence() -> None:
...
def test_batch_c_performance_candidate_keeps_later_work_closed() -> None:
