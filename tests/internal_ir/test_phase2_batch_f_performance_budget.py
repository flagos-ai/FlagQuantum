...
from benchmarks.internal import ir_phase2_batch_f_baseline as gate
...
def test_batch_f_machine_gate_accepts_boundaries_and_rejects_regression(
    ...
    def observation(gate_count: int, *, iterations: int, warmup: int) -> dict[str, Any]:
        ...
        return {
            ...
            "cold_end_to_end_p95_ms": budget["cold_end_to_end_p95_ms_max"],
            "cached_end_to_end_p95_ms": budget["cached_end_to_end_p95_ms_max"],
            "cold_peak_host_memory_bytes": memory,
            "emitted_text_bytes": 1,
            "deterministic_identity": True,
            "deterministic_text_size": True,
        }
