...
AUTHORIZATION = (
    ROOT / "contracts/ir-phase3-batch-a-performance-budget-authorization.json"
)
VALIDATION = ROOT / "contracts/ir-phase3-batch-a-performance-budget-validation.json"
...
def test_batch_a_performance_authorization_binds_review_budget_and_baseline() -> None:
...
def test_batch_a_performance_authorization_keeps_later_work_closed() -> None:
    authorization = json.loads(AUTHORIZATION.read_text(encoding="utf-8"))
...
def test_batch_a_budget_validation_is_bound_and_fail_closed() -> None:
    ...
    assert validation["decisions"]["batch_b_target_ir_authorized"] is False
