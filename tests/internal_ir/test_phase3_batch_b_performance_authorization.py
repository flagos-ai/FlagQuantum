...
AUTHORIZATION = (
    ROOT / "contracts/ir-phase3-batch-b-performance-budget-authorization.json"
)
VALIDATION = ROOT / "contracts/ir-phase3-batch-b-performance-budget-validation.json"
...
def test_batch_b_performance_authorization_keeps_later_work_closed() -> None:
    ...
    assert decisions["batch_c_executable_artifact_authorized"] is False
...
def test_batch_b_budget_validation_is_bound_and_fail_closed() -> None:
    ...
    assert validation["decisions"]["batch_c_executable_artifact_authorized"] is False
