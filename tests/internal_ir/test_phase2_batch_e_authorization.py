...
AUTHORIZATION = ROOT / "contracts/ir-phase2-batch-d-exit-batch-e-authorization.json"
...
def test_batch_e_authorization_binds_exit_candidate() -> None:
...
def test_batch_e_authorization_keeps_later_gates_closed() -> None:
