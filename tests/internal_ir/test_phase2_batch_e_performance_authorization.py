...
AUTHORIZATION = (
    ROOT / "contracts/ir-phase2-batch-e-performance-budget-authorization.json"
)
VALIDATION = ROOT / "contracts/ir-phase2-batch-e-performance-budget-validation.json"
...
def test_batch_e_performance_authorization_keeps_later_gates_closed() -> None:
...
def test_batch_e_budget_validation_is_bound_and_fail_closed() -> None:
    ...
    assert validation["decisions"]["batch_f_authorized"] is False
