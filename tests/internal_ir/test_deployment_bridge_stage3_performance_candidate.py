...
BASELINE = ROOT / "contracts/deployment-bridge-stage3-performance-baseline.json"
BUDGET = (
    ROOT
    / "tests/fixtures/internal_ir/deployment_bridge_stage3_performance_budget_candidate.json"
)
...
def test_stage3_budget_candidate_is_unapproved_and_above_baseline() -> None:
    baseline = _load(BASELINE)
    ...
    budgets = {item["evaluation_count"]: item for item in candidate["budgets"]}
