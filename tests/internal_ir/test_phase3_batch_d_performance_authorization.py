...
AUTHORIZATION = (
    ROOT / "contracts/ir-phase3-batch-d-performance-budget-authorization.json"
)
VALIDATION = ROOT / "contracts/ir-phase3-batch-d-performance-budget-validation.json"
...
def test_batch_d_performance_authorization_keeps_later_work_closed() -> None:
...
def test_batch_d_budget_validation_is_bound_and_fail_closed() -> None:
    ...
    assert validation["decisions"]["batch_e_provider_conformance_authorized"] is False
