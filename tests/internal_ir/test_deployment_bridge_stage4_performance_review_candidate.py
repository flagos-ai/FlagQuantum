...
REVIEW = (
    ROOT / "contracts/deployment-bridge-stage4-performance-budget-review-candidate.json"
)
...
def test_stage4_performance_review_binds_every_artifact() -> None:
...
def test_stage4_performance_review_authorizes_only_budget_and_gate() -> None:
    review = json.loads(REVIEW.read_text(encoding="utf-8"))
