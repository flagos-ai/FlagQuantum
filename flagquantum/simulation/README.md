...
including buffered local one-qubit gates, CNOT segments, and control-one
packing/scattering used around cross-shard CX transport. Runtime decides when
to use them and owns the transport itself.
