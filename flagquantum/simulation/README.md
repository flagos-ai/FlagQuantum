...
including local CNOT and control-one packing/scattering used around cross-shard
CX transport. Runtime decides when to use them and owns the transport itself.
