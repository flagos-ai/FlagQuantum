...
class PlatformActivationError(PlatformError):
    """An optional platform provider could not be activated safely."""
...
class PlatformDevice:
    """A concrete device discovered through one platform provider."""
...
class PlatformRuntime(Protocol):
    """Minimum lifecycle surface implemented by device-platform providers."""
