...
`braket.py`, `originq.py`, `quafu.py`, and `tencent.py`; shared HTTP transport
and response normalization live in `http.py` and `result_parsing.py`. Run `python -m pytest
