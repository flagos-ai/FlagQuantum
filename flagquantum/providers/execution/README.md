...
shared HTTP transport and response normalization live in `http.py` and
`result_parsing.py`. Run `python -m pytest tests/test_amazon_braket_provider.py
tests/test_cloud_providers.py -q`.
