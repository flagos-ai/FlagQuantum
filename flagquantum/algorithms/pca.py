...
at least ``0.0055`` over 5000 seeds at 8000 shots and ``0.0169`` at 20000, and the
second example's -- its mode's share against the larger of the largest eigenvalue's
two counter values -- is at least ``0.125`` at 4096 shots and ``0.141`` at 8000.
