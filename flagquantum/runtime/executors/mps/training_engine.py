...
from .training_records import (
    ...
    summarize_boundary_reverse_work,
    summarize_owned_reverse_work,
)
...
def train_distributed_mps(
    ...
    *,
    ...
    for step in range(start_step, steps):
        ...
        ) = summarize_owned_reverse_work(reverse.tape.records, rank)
        boundaries, boundary_bytes, bond_updates = summarize_boundary_reverse_work(
