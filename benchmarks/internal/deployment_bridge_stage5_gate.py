"""Enforce the private Deployment Bridge Stage 5 regression budget."""
...
DEFAULT_BUDGET = (
    ...
    / "fixtures"
    / "internal_ir"
    / "deployment_bridge_stage5_performance_budget.json"
)
...
def evaluate(
    ...
    *,
    ...
    if budget_payload.get("status") != "active_private_regression_budget":
        raise ValueError("Stage 5 performance budget is not active")
    budgets = {
