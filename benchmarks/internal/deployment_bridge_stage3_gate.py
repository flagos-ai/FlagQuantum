"""Enforce the private Deployment Bridge Stage 3 regression budget."""
...
DEFAULT_BUDGET = (
    ...
    / "fixtures"
    / "internal_ir"
    / "deployment_bridge_stage3_performance_budget.json"
)
...
def evaluate(
    ...
    *,
    ...
    if budget_payload.get("status") != "active_private_regression_budget":
        raise ValueError("Stage 3 performance budget is not active")
    budgets = {
