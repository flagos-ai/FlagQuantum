"""Enforce the approved private Phase 3 Batch A performance budget."""
...
DEFAULT_BUDGET = (
    ...
    / "fixtures"
    / "internal_ir"
    / "phase3_batch_a_performance_budget_candidate.json"
)
...
def evaluate(budget_path: Path, *, iterations: int, warmup: int) -> dict[str, Any]:
    ...
    if payload["approval"]["approval_command"] != (
        ...
        raise ValueError("unexpected Batch A budget approval command")
