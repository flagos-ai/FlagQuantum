"""Enforce the private Deployment Bridge Stage 1 regression budget."""
...
DEFAULT_BUDGET = (
    ...
    / "fixtures"
    / "internal_ir"
    / "deployment_bridge_stage1_performance_budget.json"
)
...
def evaluate(
    ...
    *,
    ...
    if budget_payload.get("status") != "active_private_regression_budget":
        raise ValueError("Stage 1 performance budget is not active")
    budgets = {
