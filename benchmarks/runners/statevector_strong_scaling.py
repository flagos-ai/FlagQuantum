"""Contract-aware adapter for the historical strong-scaling report builder."""
...
def main() -> int:
    ...
    payload = runtime_metadata(
        runner="statevector_strong_scaling",
        schema="flagquantum.benchmark.statevector_strong_scaling.v1",
        report=report,
    )
