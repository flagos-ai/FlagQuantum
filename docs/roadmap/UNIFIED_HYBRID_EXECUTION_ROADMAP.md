...
- [IR 实现状态](../development/IR_IMPLEMENTATION_STATUS.md)
- [IR Phase 2 准入与 Batch A 授权包](../development/IR_PHASE_2_ENTRY_APPROVAL_PACKET.md)
- [Quafu Provider 与门户任务契约](../development/API_CHANGE_PROPOSAL_012_QUAFU_PROVIDER_CONTRACT.md)
- [Stage 2 Quafu 准入审计](../development/STAGE_2_QUAFU_ENTRY_AUDIT.md)
