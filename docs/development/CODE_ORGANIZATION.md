...
adapters. Quantum-specific task contracts live in `flagquantum.remote.quantum`;
future remote compute services must not reuse its shots-and-counts result model.
