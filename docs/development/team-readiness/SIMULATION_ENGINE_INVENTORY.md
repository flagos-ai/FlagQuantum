...
| `simulation/jax_mps.py` | 纯数值算法 | JAX MPS 单/双站点更新、pair 分解、远程门 swap 路由、statevector 收缩与 observable transfer | 无 Runtime/Platform 依赖；Runtime 保留 circuit loop、backend 和执行证据 |
