...
| `simulation/mps/rank_local.py`、`mps_site_kernels.py`、`mps/factorization.py` | 纯数值算法/Kernel 调用 | 门作用、环境 transfer、QR/SVD 分解 | Runtime 只保留显存预算、微批规划、workspace 池和 Runtime 错误翻译；原 Runtime 数值模块已删除 |
