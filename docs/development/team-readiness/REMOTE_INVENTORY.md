...
Remote adapters adapt complete external execution targets. They discover a
...
Concrete adapters live in `remote`, but their shared
...
Remote adapter convergence is complete only when:
