...
| 动态电路 | `runtime/dynamic/conformance.py`、`runtime/dynamic/deployment.py` | mid-circuit measurement/reset、feed-forward、结果返回、provider dynamic support | 当前是局部 conformance/deployment 检查，尚未并入统一 RequirementSet/Snapshot 匹配 |
