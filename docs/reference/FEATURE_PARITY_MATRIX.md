...
| --- | --- | --- |
| Product capabilities and maturity | [`capability-maturity.toml`](../../capability-maturity.toml) | Machine-validated user goals, maturity, examples, support boundaries, and evidence; see the [generated capability catalog](../generated/CAPABILITIES.md) |
