...
| Dynamic circuits and IQM Braket preflight | `experimental` | DynamicCircuit construction is candidate-stable pending API-owner approval; execution, native result, routing, deployment, dialects and providers remain experimental. Provider-neutral conformance passes locally and on Qiskit Aer, but no real IQM QPU task was used. |
